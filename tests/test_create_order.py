...
class TestCreateOrder:
    @allure.title('Проверка на успешное создания заказа авторизованным пользователем')
    ...
    @allure.title('Проверка на создание заказа c неправильным хешем ингредиентов')
