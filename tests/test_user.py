...
class TestCreateUser:
    @allure.title('Проверка на успешную регистрацию пользователя')
    ...
    @allure.title('Проверка на создание пользователя с уже существующими данными')
    ...
    @allure.title('Проверка на создание пользователя без обязательных полей')
